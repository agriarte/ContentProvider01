...
/**
 * Created by Pedro on 04/10/2017.
 */

public class ClientesProvider extends ContentProvider {

    //definicion del ContentUri
    private static final String uri = "content://com.example.pedro.contentprovider01/clientes";
    public static final Uri CONTENT_URI = Uri.parse(uri);

    //clase estática para definir las constantes de columna
    ...
    static{
        ...
        uriMatcher.addURI("com.example.pedro.contentprovider01","clientes",CLIENTES);
        uriMatcher.addURI("com.example.pedro.contentprovider01","clientes/#",CLIENTES_ID);
    }
    @Override
